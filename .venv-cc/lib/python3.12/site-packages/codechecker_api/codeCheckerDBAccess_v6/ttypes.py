...
class ReportData(object):
    ...
    def __init__(self, runId = None, checkerId = None, bugHash = None, checkedFile = None, checkerMsg = None, reportId = None, fileId = None, line = None, column = None, severity = None, reviewData = None, detectionStatus = None, detectedAt = None, fixedAt = None, bugPathLength = None, details = None, analyzerName = None, annotations = None, blameInfo = None,):
        self.runId = runId
    ...
    def write(self, oprot):
        ...
        if self.blameInfo is not None:
            oprot.writeFieldBegin('blameInfo', TType.STRUCT, 19)
            self.blameInfo.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class FilterPreset(object):
    ...
    def __init__(self, id = None, name = None, reportFilter = None,):
        self.id = id
        self.name = name
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('FilterPreset')
        if self.id is not None:
...
class Rule(object):
    ...
    def __init__(self, ruleId = None, title = None, url = None, checkers = None, level = None,):
        self.ruleId = ruleId
        self.title = title
        self.url = url
        self.checkers = checkers
    ...
    def write(self, oprot):
        ...
        if self.level is not None:
            oprot.writeFieldBegin('level', TType.STRING, 5)
...
ReportData.thrift_spec = (
    ...
    (19, TType.STRUCT, 'blameInfo', [BlameInfo, None], None, ),  # 19
)
...
all_structs.append(FilterPreset)
FilterPreset.thrift_spec = (
    None,  # 0
...
Rule.thrift_spec = (
    ...
    (5, TType.STRING, 'level', 'UTF8', None, ),  # 5
)
