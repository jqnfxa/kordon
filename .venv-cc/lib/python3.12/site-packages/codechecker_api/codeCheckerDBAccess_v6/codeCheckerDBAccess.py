...
class Client(Iface):
    ...
    def storeFilterPreset(self, preset):
        ...
        """
        self.send_storeFilterPreset(preset)
        return self.recv_storeFilterPreset()

    def send_storeFilterPreset(self, preset):
        self._oprot.writeMessageBegin('storeFilterPreset', TMessageType.CALL, self._seqid)
        args = storeFilterPreset_args()
        args.preset = preset
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_storeFilterPreset(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = storeFilterPreset_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "storeFilterPreset failed: unknown result")
    ...
    def renameFilterPreset(self, id, name):
        ...
        """
        self.send_renameFilterPreset(id, name)
        return self.recv_renameFilterPreset()

    def send_renameFilterPreset(self, id, name):
        self._oprot.writeMessageBegin('renameFilterPreset', TMessageType.CALL, self._seqid)
        args = renameFilterPreset_args()
        args.id = id
        args.name = name
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_renameFilterPreset(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = renameFilterPreset_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "renameFilterPreset failed: unknown result")
    ...
    def getFilterPreset(self, id):
        ...
        """
        self.send_getFilterPreset(id)
        return self.recv_getFilterPreset()

    def send_getFilterPreset(self, id):
        self._oprot.writeMessageBegin('getFilterPreset', TMessageType.CALL, self._seqid)
        args = getFilterPreset_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getFilterPreset(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getFilterPreset failed: unknown result")
    ...
    def deleteFilterPreset(self, id):
        ...
        """
        self.send_deleteFilterPreset(id)
        return self.recv_deleteFilterPreset()

    def send_deleteFilterPreset(self, id):
        self._oprot.writeMessageBegin('deleteFilterPreset', TMessageType.CALL, self._seqid)
        args = deleteFilterPreset_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_deleteFilterPreset(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = deleteFilterPreset_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "deleteFilterPreset failed: unknown result")

    def listFilterPreset(self):
        self.send_listFilterPreset()
        return self.recv_listFilterPreset()

    def send_listFilterPreset(self):
        self._oprot.writeMessageBegin('listFilterPreset', TMessageType.CALL, self._seqid)
        args = listFilterPreset_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_listFilterPreset(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = listFilterPreset_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "listFilterPreset failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["storeFilterPreset"] = Processor.process_storeFilterPreset
        self._processMap["renameFilterPreset"] = Processor.process_renameFilterPreset
        self._processMap["getFilterPreset"] = Processor.process_getFilterPreset
        self._processMap["deleteFilterPreset"] = Processor.process_deleteFilterPreset
        self._processMap["listFilterPreset"] = Processor.process_listFilterPreset
    ...
    def process_storeFilterPreset(self, seqid, iprot, oprot):
        args = storeFilterPreset_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = storeFilterPreset_result()
        try:
            result.success = self._handler.storeFilterPreset(args.preset)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("storeFilterPreset", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_renameFilterPreset(self, seqid, iprot, oprot):
        args = renameFilterPreset_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = renameFilterPreset_result()
        try:
            result.success = self._handler.renameFilterPreset(args.id, args.name)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("renameFilterPreset", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_getFilterPreset(self, seqid, iprot, oprot):
        args = getFilterPreset_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getFilterPreset_result()
        try:
            result.success = self._handler.getFilterPreset(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getFilterPreset", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_deleteFilterPreset(self, seqid, iprot, oprot):
        args = deleteFilterPreset_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = deleteFilterPreset_result()
        try:
            result.success = self._handler.deleteFilterPreset(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deleteFilterPreset", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_listFilterPreset(self, seqid, iprot, oprot):
        args = listFilterPreset_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = listFilterPreset_result()
        try:
            result.success = self._handler.listFilterPreset()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("listFilterPreset", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class storeFilterPreset_args(object):
    """
    Attributes:
     - preset
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.preset = FilterPreset()
                    self.preset.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('storeFilterPreset_args')
        if self.preset is not None:
            oprot.writeFieldBegin('preset', TType.STRUCT, 1)
            self.preset.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(storeFilterPreset_args)
storeFilterPreset_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'preset', [FilterPreset, None], None, ),  # 1
)


class storeFilterPreset_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('storeFilterPreset_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(storeFilterPreset_result)
storeFilterPreset_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class renameFilterPreset_args(object):
    """
    Attributes:
     - id
     - name
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('renameFilterPreset_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(renameFilterPreset_args)
renameFilterPreset_args.thrift_spec = (
    None,  # 0
...
class renameFilterPreset_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('renameFilterPreset_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I64, 0)
            oprot.writeI64(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(renameFilterPreset_result)
renameFilterPreset_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class getFilterPreset_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getFilterPreset_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.I64, 1)
            oprot.writeI64(self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getFilterPreset_args)
getFilterPreset_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'id', None, None, ),  # 1
)


class getFilterPreset_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getFilterPreset_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getFilterPreset_result)
getFilterPreset_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [FilterPreset, None], None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class deleteFilterPreset_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteFilterPreset_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.I64, 1)
            oprot.writeI64(self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteFilterPreset_args)
deleteFilterPreset_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'id', None, None, ),  # 1
)


class deleteFilterPreset_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteFilterPreset_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I64, 0)
            oprot.writeI64(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteFilterPreset_result)
deleteFilterPreset_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class listFilterPreset_args(object):
    thrift_spec = None
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('listFilterPreset_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(listFilterPreset_args)
listFilterPreset_args.thrift_spec = (
)


class listFilterPreset_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('listFilterPreset_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(listFilterPreset_result)
listFilterPreset_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [FilterPreset, None], False), None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)
...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i406 in range(_size402):
                        ...
                        self.reportHashes.append(_elem407)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i412 in range(_size408):
                        ...
                        self.skipDetectionStatuses.append(_elem413)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter421 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter422 in self.skipDetectionStatuses:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i463 in range(_size459):
                        _elem464 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter514, viter515 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRUCT, len(viter515))
                for iter516 in viter515:
                    iter516.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i521 in range(_size517):
                        _elem522 = LinesInFilesRequested()
                        _elem522.read(iprot)
                        self.linesInFilesRequested.append(_elem522)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter523 in self.linesInFilesRequested:
                iter523.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter538, viter539 in self.success.items():
                oprot.writeI64(kiter538)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter539))
                for kiter540, viter541 in viter539.items():
                    oprot.writeI64(kiter540)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter575 in self.success:
                oprot.writeListBegin(TType.STRING, len(iter575))
                for iter576 in iter575:
...
class getGuidelineRules_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i581 in range(_size577):
                        _elem582 = Guideline()
                        _elem582.read(iprot)
                        self.guidelines.append(_elem582)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.guidelines is not None:
            ...
            for iter583 in self.guidelines:
                iter583.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class getGuidelineRules_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i588 in range(_size584):
                        _key589 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val590 = []
                        (_etype594, _size591) = iprot.readListBegin()
                        for _i595 in range(_size591):
                            _elem596 = Rule()
                            _elem596.read(iprot)
                            _val590.append(_elem596)
                        iprot.readListEnd()
                        self.success[_key589] = _val590
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.success))
            for kiter597, viter598 in self.success.items():
                oprot.writeString(kiter597.encode('utf-8') if sys.version_info[0] == 2 else kiter597)
                oprot.writeListBegin(TType.STRUCT, len(viter598))
...
class getSeverityCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter628, viter629 in self.success.items():
                oprot.writeI32(kiter628)
                oprot.writeI64(viter629)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getCheckerMsgCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i641 in range(_size637):
                        _key642 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val643 = iprot.readI64()
                        self.success[_key642] = _val643
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter644, viter645 in self.success.items():
                oprot.writeString(kiter644.encode('utf-8') if sys.version_info[0] == 2 else kiter644)
                oprot.writeI64(viter645)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter660, viter661 in self.success.items():
                oprot.writeI32(kiter660)
                oprot.writeI64(viter661)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getDetectionStatusCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter692, viter693 in self.success.items():
                oprot.writeI32(kiter692)
                oprot.writeI64(viter693)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getFileCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter700 in self.runIds:
                oprot.writeI64(iter700)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getFileCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i705 in range(_size701):
                        _key706 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val707 = iprot.readI64()
                        self.success[_key706] = _val707
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.success))
            for kiter708, viter709 in self.success.items():
                oprot.writeString(kiter708.encode('utf-8') if sys.version_info[0] == 2 else kiter708)
                oprot.writeI64(viter709)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getCheckerStatusVerificationDetails_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i735 in range(_size731):
                        _key736 = iprot.readI64()
                        _val737 = CheckerStatusVerificationDetail()
                        _val737.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter738, viter739 in self.success.items():
                oprot.writeI64(kiter738)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i774 in range(_size770):
                        ...
                        self.sourceComponentFilter.append(_elem775)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter776 in self.sourceComponentFilter:
...
class getMissingContentHashesForBlameInfo_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i802 in range(_size798):
                        ...
                        self.fileHashes.append(_elem803)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            oprot.writeFieldBegin('fileHashes', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.fileHashes))
            for iter804 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i816 in range(_size812):
                        _elem817 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.trimPathPrefixes.append(_elem817)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter818 in self.trimPathPrefixes:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i823 in range(_size819):
                        _key824 = iprot.readI32()
                        _val825 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter826, viter827 in self.success.items():
                oprot.writeI32(kiter826)
                oprot.writeI64(viter827)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i832 in range(_size828):
                        _key833 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val834 = AnalyzerStatistics()
                        _val834.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter835, viter836 in self.success.items():
                oprot.writeString(kiter835.encode('utf-8') if sys.version_info[0] == 2 else kiter835)
...
class unsetCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i855 in range(_size851):
                        ...
                        self.reportHashes.append(_elem856)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter857 in self.reportHashes:
